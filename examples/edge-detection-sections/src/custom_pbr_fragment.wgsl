// This file is currently copied from
// https://github.com/bevyengine/bevy/blob/1030a99b8e2680a7e696d6433b79f5671768231c/crates/bevy_pbr/src/render/pbr_fragment.wgsl
// It *must* be kept in sync with bevy releases
//
// Modifications include:
// - Removing vertex_color processing
//   * vertex colors will override sampled textures, so we need to "disable" them
//     in the fragment shader, but not in the vertex shader.
//

#define_import_path bevy_segment_outline::bevy_pbr::pbr_fragment
