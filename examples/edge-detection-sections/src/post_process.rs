use crate::vertex_color_material::{
    VertexColorSectionId, VertexColorSectionTestMaterial,
};
use bevy::{
    core_pipeline::{
...
impl Plugin for PostProcessPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((
            ExtractComponentPlugin::<VertexColorSectionId>::default(),
        ...
        app.add_systems(Last, update_vertex_id_texture);
