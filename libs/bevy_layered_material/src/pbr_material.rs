...
use bevy_render::{
    alpha::AlphaMode, render_asset::RenderAssets, render_resource::*, texture::GpuImage,
};
...
///
/// It is used for every texture in the [`LayeredMaterial`].
...
#[bind_group_data(LayeredMaterialKey)]
#[data(0, LayeredMaterialUniform, binding_array(10))]
...
pub struct LayeredMaterial {
    ...
    /// The UV channel to use for the [`LayeredMaterial::base_color_texture`].
    ///
    ...
    ///
    /// [`base_color`]: LayeredMaterial::base_color
    ...
    /// The UV channel to use for the [`LayeredMaterial::emissive_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    ...
    /// The UV channel to use for the [`LayeredMaterial::metallic_roughness_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    ...
    /// A color with which to modulate the [`LayeredMaterial::reflectance`] for
    /// non-metals.
    ///
    ...
    ///
    /// For specular transmission usecases with refraction (e.g. glass) use the [`LayeredMaterial::specular_transmission`] and
    /// [`LayeredMaterial::ior`] properties instead.
    ///
    ...
    /// ## Notes
    ///
    /// - The material's [`LayeredMaterial::base_color`] also modulates the transmitted light;
    ...
    /// The UV channel to use for the [`LayeredMaterial::diffuse_transmission_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    #[cfg(feature = "pbr_transmission_textures")]
    pub diffuse_transmission_channel: UvChannel,

    /// A map that modulates diffuse transmission via its alpha channel. Multiplied by [`LayeredMaterial::diffuse_transmission`]
    /// to obtain the final result.
    ///
    /// **Important:** The [`LayeredMaterial::diffuse_transmission`] property must be set to a value higher than 0.0,
    ...
    /// The material's [`LayeredMaterial::base_color`] also modulates the transmitted light.
    ///
    /// **Note:** Typically used in conjunction with [`LayeredMaterial::thickness`], [`LayeredMaterial::ior`] and [`LayeredMaterial::perceptual_roughness`].
    ///
    /// ## Performance
    ///
    ...
    /// - If purely diffuse light transmission is needed, (i.e. “translucency”) consider using [`LayeredMaterial::diffuse_transmission`] instead,
    ...
    /// The UV channel to use for the [`LayeredMaterial::specular_transmission_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    #[cfg(feature = "pbr_transmission_textures")]
    pub specular_transmission_channel: UvChannel,

    /// A map that modulates specular transmission via its red channel. Multiplied by [`LayeredMaterial::specular_transmission`]
    /// to obtain the final result.
    ///
    /// **Important:** The [`LayeredMaterial::specular_transmission`] property must be set to a value higher than 0.0,
    /// or this texture won't have any effect.
    ...
    ///
    /// **Note:** Typically used in conjunction with [`LayeredMaterial::specular_transmission`] and [`LayeredMaterial::ior`], or with
    /// [`LayeredMaterial::diffuse_transmission`].
    #[doc(alias = "volume")]
    #[doc(alias = "thin_walled")]
    pub thickness: f32,

    /// The UV channel to use for the [`LayeredMaterial::thickness_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    #[cfg(feature = "pbr_transmission_textures")]
    pub thickness_channel: UvChannel,

    /// A map that modulates thickness via its green channel. Multiplied by [`LayeredMaterial::thickness`]
    /// to obtain the final result.
    ///
    /// **Important:** The [`LayeredMaterial::thickness`] property must be set to a value higher than 0.0,
    /// or this texture won't have any effect.
    ...
    /// | Moissanite      | 2.65                 |
    ///
    /// **Note:** Typically used in conjunction with [`LayeredMaterial::specular_transmission`] and [`LayeredMaterial::thickness`].
    ...
    /// - [`LayeredMaterial::attenuation_color`];
    /// - [`LayeredMaterial::thickness`];
    /// - [`LayeredMaterial::diffuse_transmission`] or [`LayeredMaterial::specular_transmission`].
    ...
    ///
    /// **Note:** To have any effect, must be used in conjunction with:
    /// - [`LayeredMaterial::attenuation_distance`];
    /// - [`LayeredMaterial::thickness`];
    /// - [`LayeredMaterial::diffuse_transmission`] or [`LayeredMaterial::specular_transmission`].
    ...
    /// The UV channel to use for the [`LayeredMaterial::normal_map_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    ...
    /// # Notes
    ///
    /// Normal mapping with `LayeredMaterial` and the core bevy PBR shaders requires:
    ...
    /// The UV channel to use for the [`LayeredMaterial::occlusion_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    ...
    /// The UV channel to use for the [`LayeredMaterial::specular_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    ...
    /// [`LayeredMaterial::reflectance`] value. This follows the
    ...
    /// [`LayeredMaterial::reflectance`] value to 2.0 so that this map can
    /// express the full [0.0, 1.0] range of values.
    ///
    /// Note that, because the reflectance is stored in the alpha channel, and
    /// the [`LayeredMaterial::specular_tint_texture`] has no alpha value, it
    ...
    /// [`LayeredMaterial::specular_tint_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    #[cfg(feature = "pbr_specular_textures")]
    ...
    /// [`LayeredMaterial::specular_tint`] value. See the documentation for
    ...
    /// The UV channel to use for the [`LayeredMaterial::clearcoat_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    ...
    /// main [`LayeredMaterial::clearcoat`] factor.
    ///
    ...
    /// the same way as the [`LayeredMaterial::perceptual_roughness`].
    ///
    /// If the [`LayeredMaterial::clearcoat`] value if zero, this has no
    /// effect.
    ///
    /// Defaults to 0.5.
    pub clearcoat_perceptual_roughness: f32,

    /// The UV channel to use for the [`LayeredMaterial::clearcoat_roughness_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    #[cfg(feature = "pbr_multi_layer_material_textures")]
    ...
    /// [`LayeredMaterial::clearcoat_perceptual_roughness`] factor.
    ///
    /// As this is a non-color map, it must not be loaded as sRGB.
    ...
    /// The UV channel to use for the [`LayeredMaterial::clearcoat_normal_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    #[cfg(feature = "pbr_multi_layer_material_textures")]
    ...
    /// format as [`LayeredMaterial::normal_map_texture`].
    ///
    ...
    /// in both [`LayeredMaterial::normal_map_texture`] and this field.
    ///
    /// As this is a non-color map, it must not be loaded as sRGB.
    ...
    /// [`LayeredMaterial::anisotropy_rotation`] of 0) aligns with the
    ...
    /// the [`LayeredMaterial::anisotropy_rotation`] parameter.
    ///
    ...
    /// [`LayeredMaterial::anisotropy_strength`]. The rotation is applied in
    ...
    /// [`LayeredMaterial::anisotropy_strength`] is zero. Its value can
    /// optionally be adjusted across the mesh with the
    /// [`LayeredMaterial::anisotropy_texture`].
    ///
    /// See the [`KHR_materials_anisotropy` specification] for more details.
    ///
    /// [`KHR_materials_anisotropy` specification]:
    ...
    /// The UV channel to use for the [`LayeredMaterial::anisotropy_texture`].
    ///
    /// Defaults to [`UvChannel::Uv0`].
    ...
    /// [`LayeredMaterial::anisotropy_strength`] and
    /// [`LayeredMaterial::anisotropy_rotation`] to vary across the mesh.
    ///
    ...
    /// [`LayeredMaterial::anisotropy_rotation`] parameter is applied. The
    /// value in the blue channel is multiplied by the
    /// [`LayeredMaterial::anisotropy_strength`] value to produce the final
    /// anisotropy strength.
    ///
    ...
    /// [`parallax_depth_scale`]: LayeredMaterial::parallax_depth_scale
    /// [`parallax_mapping_method`]: LayeredMaterial::parallax_mapping_method
    /// [`max_parallax_layer_count`]: LayeredMaterial::max_parallax_layer_count
    #[texture(11)]
    #[sampler(12)]
    #[dependency]
    ...
    /// TODO: bevy_layered_materials.
    /// The index to render. A temporary solution to checking
...
impl Default for LayeredMaterial {
    fn default() -> Self {
        LayeredMaterial {
...
impl From<Color> for LayeredMaterial {
...
impl From<Handle<Image>> for LayeredMaterial {
...
bitflags::bitflags! {
    ...
    /// This is accessible in the shader in the [`LayeredMaterialUniform`]
    #[repr(transparent)]
    pub struct LayeredMaterialFlags: u32 {
...
impl LayeredMaterialFlags {
    const ALPHA_MODE_MASK_BITS: u32 = 0b111;
    const ALPHA_MODE_SHIFT_BITS: u32 = 32 - Self::ALPHA_MODE_MASK_BITS.count_ones();
}

/// The GPU representation of the uniform data of a [`LayeredMaterial`].
#[derive(Clone, Default, ShaderType)]
pub struct LayeredMaterialUniform {
    /// Doubles as diffuse albedo for non-metallic, specular for metallic and a mix for everything
    /// in between.
    pub base_color: Vec4,
    // Use a color for user-friendliness even though we technically don't use the alpha channel
    ...
    /// The [`LayeredMaterialFlags`] accessible in the `wgsl` shader.
    pub flags: u32,
    /// When the alpha mode mask flag is set, any base color alpha above this cutoff means fully opaque,
    /// and any below means fully transparent.
    pub alpha_cutoff: f32,
    /// The depth of the [`LayeredMaterial::depth_map`] to apply.
    pub parallax_depth_scale: f32,
...
impl AsBindGroupShaderType<LayeredMaterialUniform> for LayeredMaterial {
    fn as_bind_group_shader_type(&self, images: &RenderAssets<GpuImage>) -> LayeredMaterialUniform {
        let mut flags = LayeredMaterialFlags::NONE;
        if self.base_color_texture.is_some() {
            flags |= LayeredMaterialFlags::BASE_COLOR_TEXTURE;
        }
        if self.emissive_texture.is_some() {
            flags |= LayeredMaterialFlags::EMISSIVE_TEXTURE;
        }
        if self.metallic_roughness_texture.is_some() {
            flags |= LayeredMaterialFlags::METALLIC_ROUGHNESS_TEXTURE;
        }
        if self.occlusion_texture.is_some() {
            flags |= LayeredMaterialFlags::OCCLUSION_TEXTURE;
        }
        if self.double_sided {
            flags |= LayeredMaterialFlags::DOUBLE_SIDED;
        }
        if self.unlit {
            flags |= LayeredMaterialFlags::UNLIT;
        }
        if self.fog_enabled {
            flags |= LayeredMaterialFlags::FOG_ENABLED;
        }
        if self.depth_map.is_some() {
            flags |= LayeredMaterialFlags::DEPTH_MAP;
        }
        #[cfg(feature = "pbr_transmission_textures")]
        {
            if self.specular_transmission_texture.is_some() {
                flags |= LayeredMaterialFlags::SPECULAR_TRANSMISSION_TEXTURE;
            }
            if self.thickness_texture.is_some() {
                flags |= LayeredMaterialFlags::THICKNESS_TEXTURE;
            }
            if self.diffuse_transmission_texture.is_some() {
                flags |= LayeredMaterialFlags::DIFFUSE_TRANSMISSION_TEXTURE;
            }
        }
        ...
        #[cfg(feature = "pbr_anisotropy_texture")]
        {
            if self.anisotropy_texture.is_some() {
                flags |= LayeredMaterialFlags::ANISOTROPY_TEXTURE;
            }
        }
        ...
        #[cfg(feature = "pbr_specular_textures")]
        {
            if self.specular_texture.is_some() {
                flags |= LayeredMaterialFlags::SPECULAR_TEXTURE;
            }
            if self.specular_tint_texture.is_some() {
                flags |= LayeredMaterialFlags::SPECULAR_TINT_TEXTURE;
            }
        }
        ...
        #[cfg(feature = "pbr_multi_layer_material_textures")]
        {
            if self.clearcoat_texture.is_some() {
                flags |= LayeredMaterialFlags::CLEARCOAT_TEXTURE;
            }
            if self.clearcoat_roughness_texture.is_some() {
                flags |= LayeredMaterialFlags::CLEARCOAT_ROUGHNESS_TEXTURE;
            }
            if self.clearcoat_normal_texture.is_some() {
                flags |= LayeredMaterialFlags::CLEARCOAT_NORMAL_TEXTURE;
            }
        }
            ...
            if let Some(texture) = images.get(normal_map_id) {
                match texture.texture_format {
                    ...
                    | TextureFormat::EacRg11Unorm => {
                        flags |= LayeredMaterialFlags::TWO_COMPONENT_NORMAL_MAP;
                    }
                    _ => {}
                }
            }
            if self.flip_normal_map_y {
                flags |= LayeredMaterialFlags::FLIP_NORMAL_MAP_Y;
            }
        }
        // NOTE: 0.5 is from the glTF default - do we want this?
        let mut alpha_cutoff = 0.5;
        match self.alpha_mode {
            AlphaMode::Opaque => flags |= LayeredMaterialFlags::ALPHA_MODE_OPAQUE,
            AlphaMode::Mask(c) => {
                alpha_cutoff = c;
                flags |= LayeredMaterialFlags::ALPHA_MODE_MASK;
            }
            AlphaMode::Blend => flags |= LayeredMaterialFlags::ALPHA_MODE_BLEND,
            AlphaMode::Premultiplied => flags |= LayeredMaterialFlags::ALPHA_MODE_PREMULTIPLIED,
            AlphaMode::Add => flags |= LayeredMaterialFlags::ALPHA_MODE_ADD,
            AlphaMode::Multiply => flags |= LayeredMaterialFlags::ALPHA_MODE_MULTIPLY,
            AlphaMode::AlphaToCoverage => {
                flags |= LayeredMaterialFlags::ALPHA_MODE_ALPHA_TO_COVERAGE;
            }
        };

        if self.attenuation_distance.is_finite() {
            flags |= LayeredMaterialFlags::ATTENUATION_ENABLED;
        }
        ...
        LayeredMaterialUniform {
            ...
            // TODO: make max_steps pub upstream
            // max_relief_mapping_search_steps: self.parallax_mapping_method.max_steps(),
            max_relief_mapping_search_steps: crate::max_steps(&self.parallax_mapping_method),
...
bitflags! {
    /// The pipeline key for `LayeredMaterial`, packed into 64 bits.
    #[repr(C)]
    #[derive(Clone, Copy, PartialEq, Eq, Hash)]
    pub struct LayeredMaterialKey: u64 {
...
impl From<&LayeredMaterial> for LayeredMaterialKey {
    fn from(material: &LayeredMaterial) -> Self {
        let mut key = LayeredMaterialKey::empty();
        key.set(
            LayeredMaterialKey::CULL_FRONT,
            material.cull_mode == Some(Face::Front),
        );
        key.set(
            LayeredMaterialKey::CULL_BACK,
            material.cull_mode == Some(Face::Back),
        );
        key.set(
            LayeredMaterialKey::NORMAL_MAP,
            material.normal_map_texture.is_some(),
        );
        key.set(
            LayeredMaterialKey::RELIEF_MAPPING,
            matches!(
        ...
        key.set(
            LayeredMaterialKey::DIFFUSE_TRANSMISSION,
            material.diffuse_transmission > 0.0,
        );
        key.set(
            LayeredMaterialKey::SPECULAR_TRANSMISSION,
            material.specular_transmission > 0.0,
        );

        key.set(LayeredMaterialKey::CLEARCOAT, material.clearcoat > 0.0);

        #[cfg(feature = "pbr_multi_layer_material_textures")]
        key.set(
            LayeredMaterialKey::CLEARCOAT_NORMAL_MAP,
            material.clearcoat > 0.0 && material.clearcoat_normal_texture.is_some(),
        );

        key.set(
            LayeredMaterialKey::ANISOTROPY,
            material.anisotropy_strength > 0.0,
        );

        key.set(
            LayeredMaterialKey::BASE_COLOR_UV,
            material.base_color_channel != UvChannel::Uv0,
        );

        key.set(
            LayeredMaterialKey::EMISSIVE_UV,
            material.emissive_channel != UvChannel::Uv0,
        );
        key.set(
            LayeredMaterialKey::METALLIC_ROUGHNESS_UV,
            material.metallic_roughness_channel != UvChannel::Uv0,
        );
        key.set(
            LayeredMaterialKey::OCCLUSION_UV,
            material.occlusion_channel != UvChannel::Uv0,
        );
        #[cfg(feature = "pbr_transmission_textures")]
        {
            key.set(
                LayeredMaterialKey::SPECULAR_TRANSMISSION_UV,
                material.specular_transmission_channel != UvChannel::Uv0,
            );
            key.set(
                LayeredMaterialKey::THICKNESS_UV,
                material.thickness_channel != UvChannel::Uv0,
            );
            key.set(
                LayeredMaterialKey::DIFFUSE_TRANSMISSION_UV,
                material.diffuse_transmission_channel != UvChannel::Uv0,
            );
        }

        key.set(
            LayeredMaterialKey::NORMAL_MAP_UV,
        ...
        {
            key.set(
                LayeredMaterialKey::ANISOTROPY_UV,
        ...
        {
            key.set(
                LayeredMaterialKey::SPECULAR_UV,
                material.specular_channel != UvChannel::Uv0,
            );
            key.set(
                LayeredMaterialKey::SPECULAR_TINT_UV,
        ...
        {
            key.set(
                LayeredMaterialKey::CLEARCOAT_UV,
                material.clearcoat_channel != UvChannel::Uv0,
            );
            key.set(
                LayeredMaterialKey::CLEARCOAT_ROUGHNESS_UV,
                material.clearcoat_roughness_channel != UvChannel::Uv0,
            );
            key.set(
                LayeredMaterialKey::CLEARCOAT_NORMAL_UV,
                material.clearcoat_normal_channel != UvChannel::Uv0,
            );
        }

        key.insert(LayeredMaterialKey::from_bits_retain(
    ...
    fn specialize(
        ...
        if let Some(fragment) = descriptor.fragment.as_mut() {
            ...
            for (flags, shader_def) in [
                ...
                (LayeredMaterialKey::RELIEF_MAPPING, "RELIEF_MAPPING"),
                (
                    LayeredMaterialKey::DIFFUSE_TRANSMISSION,
                ...
                (LayeredMaterialKey::CLEARCOAT, "STANDARD_MATERIAL_CLEARCOAT"),
                (
                    LayeredMaterialKey::CLEARCOAT_NORMAL_MAP,
        ...
        descriptor.primitive.cull_mode =
            if key.bind_group_data.contains(LayeredMaterialKey::CULL_FRONT) {
                Some(Face::Front)
            } else if key.bind_group_data.contains(LayeredMaterialKey::CULL_BACK) {
                Some(Face::Back)
            } else {
                None
            };
